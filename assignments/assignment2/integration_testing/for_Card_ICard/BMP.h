...
struct BMPFileHeader {
    uint16_t file_type{0x4D42};          // File type always BM which is 0x4D42
                                         // the file type might actually supposed to be 0x424d? idk tbh
...
struct BMPInfoHeader {
    ...
    int32_t height{ 0 };                 // height of bitmap in pixels
                                         ...
                                         // implementation fo this SHOULD have a positive height
...
// actual BMP that will need to be made
struct BMP {
...
//just added to make filling areas easier
